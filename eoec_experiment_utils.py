...
with open(
    "markers_eoec_" + datetime.now().strftime("%d%m%Y_%H%M%S") + ".csv", "w"
) as f:
    while update.timestamp() < start.timestamp() + duration:
        ...
        if soundinstr_init and update.timestamp() > start.timestamp() + waitforinstr:
            ...
            if platform.system() == "Darwin":  # mac os
                ...
                os.system(
                    "powershell -Command \"Add-Type –AssemblyName System.Speech; (New-Object System.Speech.Synthesis.SpeechSynthesizer).Speak('relax and try not to move during the experiment')\""
                )
        ...
        if sound0_init and update.timestamp() > start.timestamp() + marker1:
            ...
            if platform.system() == "Darwin":  # mac os
                ...
                os.system(
                    "powershell -Command \"Add-Type –AssemblyName System.Speech; (New-Object System.Speech.Synthesis.SpeechSynthesizer).Speak('eyes open')\""
                )
        ...
        if sound1_init and update.timestamp() > start.timestamp() + marker1 + marker2:
            ...
            if platform.system() == "Darwin":  # mac os
                ...
                os.system(
                    "powershell -Command \"Add-Type –AssemblyName System.Speech; (New-Object System.Speech.Synthesis.SpeechSynthesizer).Speak('close your eyes')\""
                )
        ...
        if (
            sound2_init
            and update.timestamp() > start.timestamp() + marker1 + 2 * marker2
        ):
            ...
            if platform.system() == "Darwin":  # mac os
                ...
                os.system(
                    "powershell -Command \"Add-Type –AssemblyName System.Speech; (New-Object System.Speech.Synthesis.SpeechSynthesizer).Speak('well done, the experiment is finished')\""
                )
            marker = ""
            sound2_init = False
